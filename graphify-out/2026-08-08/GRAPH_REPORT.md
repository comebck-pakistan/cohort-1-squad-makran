...
## Corpus Check
- 186 files · ~73,002 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 991 nodes · 2080 edges · 71 communities (57 shown, 14 thin omitted)
...
Cohesion: 0.08
Nodes (54): fail(), GET(), fail(), GET(), GET(), addDays(), CalendarWeekView(), CalendarWeekViewProps (+46 more)

### Community 1 - "actions/proposals.ts"
Cohesion: 0.06
Nodes (45): OnboardingHeader(), OnboardingHeaderProps, STEPS, Card(), CardProps, ConnectIntegrationsScreen(), REPOS, ImportProposalsScreen() (+37 more)

### Community 2 - "createClient"
Cohesion: 0.09
Nodes (40): GET(), ClientDetailPage(), ClientsPage(), HomePage(), InsightsPage(), PreMeetingBriefingPage(), MeetingDraftReviewPage(), MeetingsPage() (+32 more)

### Community 3 - "InsightsDashboardScreen.tsx"
Cohesion: 0.15
Nodes (14): Toggle(), ToggleProps, EXAMPLE_LOST, EXAMPLE_OUTCOMES, EXAMPLE_TREND, EXAMPLE_WON, InsightsDashboardScreen(), InsightsDashboardScreenProps (+6 more)
...
### Community 5 - "db/clients.ts"
Cohesion: 0.08
Nodes (37): AnalyzeClientPayload, corsHeaders(), OPTIONS(), POST(), SettingsPage(), RateHistoryScreen(), RateHistoryScreenProps, getRateHistory() (+29 more)

### Community 6 - "actions/notifications.ts"
Cohesion: 0.11
Nodes (27): AppGroupLayout(), SettingsNotificationsPage(), ACCENTS, NotificationCard(), NotificationCardProps, NotificationType, AppShell(), AppShellProps (+19 more)
...
Cohesion: 0.10
Nodes (19): GithubMark(), GithubMarkProps, OtpCodeInput(), OtpCodeInputProps, SignInScreen(), SignUpScreen(), SocialAuthButtons(), SocialAuthButtonsProps (+11 more)

### Community 9 - "HomeScreen.tsx"
Cohesion: 0.14
Nodes (19): PageHeader(), PageHeaderProps, DataTable(), DataTableProps, ClientDetailScreen(), ClientsListScreen(), NOW, TIER_LABEL (+11 more)
...
Cohesion: 0.06
Nodes (52): { GET, POST, PUT }, POST(), SkribbyStatusUpdateEvent, TERMINAL_FAILURE_STATUSES, verifySignature(), CalendarConnected, inngest, MeetingConfirmed (+44 more)

### Community 13 - "ClientRow"
Cohesion: 0.23
Nodes (14): ClientDetailScreenProps, ClientsListScreenProps, HomeScreenProps, AddMeetingModalProps, MeetingDraftReviewScreenProps, MeetingsOverviewScreenProps, PreMeetingBriefingScreenProps, ProposalsListScreenProps (+6 more)
...
### Community 15 - "db.ts"
Cohesion: 0.09
Nodes (25): State, StateChipProps, StateDef, STATES, ProposalState, TicketState, LOST_REASONS, OutcomeCaptureModal() (+17 more)
...
### Community 17 - "components/page.tsx"
Cohesion: 0.09
Nodes (23): NOTIFICATION_TYPES, PROPOSAL_STATES, TICKET_STATES, TIERS, VERDICTS, ConsoleButton(), ConsoleButtonProps, ConfidenceTag() (+15 more)
...
Cohesion: 0.19
Nodes (14): Button(), ButtonProps, ButtonVariant, DraftTicketDraft, accentFor(), ACTION_STATES, actionFor(), FilterKey (+6 more)

### Community 20 - "devDependencies"
Cohesion: 0.12
Nodes (17): eslint, eslint-config-next, devDependencies, eslint, eslint-config-next, tailwindcss, @tailwindcss/postcss, @types/node (+9 more)

### Community 21 - "AddMeetingModal.tsx"
Cohesion: 0.33
Nodes (7): Input, InputProps, AddMeetingModal(), dateInputValue(), Mode, nextHour(), timeInputValue()
...
### Community 23 - "skribby.ts"
Cohesion: 0.27
Nodes (10): authHeaders(), CreateBotInput, createSkribbyBot(), detectService(), getSkribbyBotDetail(), getSkribbyRecordingUrl(), getSkribbyTranscript(), SkribbyBot (+2 more)
...
Cohesion: 0.13
Nodes (26): SettingsIntegrationsPage(), Select(), SelectOption, SelectProps, IntegrationsScreen(), IntegrationsScreenProps, generateExtensionToken(), getExtensionTokenStatus() (+18 more)
...
- **Why does `createClient()` connect `createClient` to `google-calendar.ts`, `actions/proposals.ts`, `db/clients.ts`, `actions/notifications.ts`, `TicketDetailScreen.tsx`, `agent-run.ts`, `IntegrationsScreen.tsx`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `Button()` connect `TicketsBoardScreen.tsx` to `google-calendar.ts`, `actions/proposals.ts`, `TicketDetailScreen.tsx`, `HomeScreen.tsx`, `db.ts`, `components/page.tsx`, `AddMeetingModal.tsx`, `IntegrationsScreen.tsx`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `ClientRow` connect `ClientRow` to `createClient`, `db/clients.ts`, `TicketDetailScreen.tsx`, `HomeScreen.tsx`, `db.ts`, `components/page.tsx`, `TicketsBoardScreen.tsx`, `AddMeetingModal.tsx`?**
