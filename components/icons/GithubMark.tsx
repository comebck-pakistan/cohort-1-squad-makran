...
/**
 * lucide-react 1.28 dropped brand/logo icons (Github included), no in-package replacement.
 * Inlined here instead of pulling in a whole second icon package for one glyph.
 */
export function GithubMark({ width = 24, height = 24, color = "currentColor", className }: GithubMarkProps) {
  return (
    <svg viewBox="0 0 24 24" width={width} height={height} fill={color} className={className} aria-hidden="true">
